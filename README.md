...
```powershell
python main.py --mode train --model swinv2_tiny --batch-size 16 --image-size 224 --resize-size 256 --epochs 50 --optimizer adamw --lr 5e-5 --weight-decay 0.05 --num-workers 4 --early-stop-patience 5 --early-stop-min-delta 0.05 --seeds 42,2024,3407 --run-name blockD_swinv2_tiny_448_3seeds --no-parts
```
